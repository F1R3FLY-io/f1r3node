...
proptest! {
    ...
    fn peek_preserves_data_produce_then_consume(
        ...
        rt.block_on(async {
            ...
            for i in 0..n {
                let d = rspace.get_store().get_data(&channels[i]);
    ...
    fn peek_preserves_data_consume_then_produce(
        ...
        rt.block_on(async {
            ...
            let c = rspace.get_store().get_continuations(&channels);
    ...
    fn persist_and_peek_interaction(
        ...
        rt.block_on(async {
            ...
            let d = rspace.get_store().get_data(&channel);
    ...
    fn persistent_consume_with_peek_preserves_both(
        ...
        rt.block_on(async {
            ...
            for i in 0..num_produces {
                ...
                let c = rspace.get_store().get_continuations(&key);
    ...
    fn peek_vs_non_peek_differential(
        ...
        rt.block_on(async {
            ...
            for i in 0..num_channels {
                let d_peek = rspace_peek.get_store().get_data(&channels[i]);
                let d_normal = rspace_normal.get_store().get_data(&channels[i]);

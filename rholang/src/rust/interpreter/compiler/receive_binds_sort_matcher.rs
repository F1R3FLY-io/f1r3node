...
mod tests {
    ...
    fn binds_should_pre_sort_based_on_their_channel_and_then_patterns() {
        ...
        let binds: Vec<(Vec<Par>, Option<Var>, Par, FreeMap<VarSort>, bool)> = vec![
            (

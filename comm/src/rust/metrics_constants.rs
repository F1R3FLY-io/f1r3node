...
pub const HANDLE_PING_METRIC: &str = "handle-ping"; // Inferred, unused in Scala reference table but keeping consistent? Scala table doesn't list handle-ping, probably implicit or missing. I will match style.
